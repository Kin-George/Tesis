# Caracterización y evolución de la pobreza en Barranquilla
...
Primer_grafico %>%
  ...
  labs(title="Pobreza y Crecimiento en Barranquilla",
...
library(dplyr)
Segundo_grafico %>%
  mutate(Segundo_grafico,isBarranquilla = Ciudad=="Barranquilla") %>%
...
Tercer_grafico %>%
  ...
  ggplot(aes(x=Año,y=PIB,color=Ciudad))+
  geom_line(aes(linetype=isBarranquilla),size=1.5,alpha=0.8)+
  theme_minimal()+
